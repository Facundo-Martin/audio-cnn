...
class AudioClassifier:
    @modal.enter()
    def load_model(self):
        print(f'Loading models on enter.')
    ...
    def inference(self, request: InferenceRequest):
        ...
        with torch.no_grad():
            ...
            top3_probs, top3_indexes = torch.topk(probabilities[0], 3)
            ...
            clean_speactogram = np.nan_to_num(spectogram_np)
            input_spectogram = {
                "shape": list(clean_speactogram.shape),
                "values": clean_speactogram.tolist(),
            }
        ...
        return {
            ...
            "input_spectogram": input_spectogram, 
            "waveform": {
...
def main():
    audio_data, sample_rate = sf.read('birds.wav')
